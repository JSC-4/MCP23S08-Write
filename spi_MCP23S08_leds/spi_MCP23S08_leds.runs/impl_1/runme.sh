...
HD_PWD='D:/VHDL_Projects/MCP23S08/spi_MCP23S08_leds/spi_MCP23S08_leds.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_MCP23S08_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_MCP23S08_top.tcl -notrace
